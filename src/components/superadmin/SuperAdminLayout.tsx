...
const SidebarContent = ({ userName, location, handleLogout }: { userName: string, location: any, handleLogout: () => void }) => (
    <aside className="flex h-full w-full flex-col bg-[#0a0a0a] border-r border-white/5 shadow-2xl overflow-hidden group">
        ...
        <div className="flex items-center gap-3 px-6 py-8">
            ...
            <div className="flex flex-col">
                <span className="font-display text-lg font-black tracking-tighter uppercase leading-none text-white">ClassBook</span>
        ...
        <div className="px-4 mb-6">
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md relative overflow-hidden group/card shadow-inner">
                ...
                <p className="font-display font-bold text-sm truncate text-white">{userName}</p>
                ...
                <div className="px-4 space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 cursor-help group/sys">
                            ...
                            <span className="text-[11px] font-black text-primary">Throughput</span>
                        </div>
    ...
    return (
        <div className="flex min-h-screen dashboard-theme bg-white text-foreground selection:bg-primary/30">
            ...
            <div className="hidden lg:block fixed left-0 top-0 z-40 h-screen w-64">
                <SidebarContent userName={userName} location={location} handleLogout={handleLogout} />
            </div>

            {/* Main content */}
            <main className="lg:ml-64 flex-1 flex flex-col min-h-screen relative overflow-x-hidden">
                {/* Mobile Header */}
                <div className="lg:hidden sticky top-0 z-30 flex items-center justify-between px-6 py-4 bg-[#0a0a0a] text-white border-b border-white/5">
                    <div className="flex items-center gap-3">
                        <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                            ...
                            <SheetContent side="left" className="p-0 w-64 bg-[#0a0a0a] border-none">
                                <SidebarContent userName={userName} location={location} handleLogout={handleLogout} />
                            </SheetContent>
                        </Sheet>
                        <span className="font-display text-sm font-black tracking-tighter uppercase leading-none">Nexus Core</span>
                    </div>
